// Clase para el Triangulo, que hereda de FiguraGeometrica
class Triangulo extends FiguraGeometrica {
    ...
    // Sobreescribe el método de la clase base con una implementación específica para el triangulo.
    // Complejidad temporal: O(1)
    @Override
    ...
    // Método para obtener el perímetro del triangulo.
    // Sobreescribe el método de la clase base con una implementación específica para el triangulo.
    // Complejidad temporal: O(1)
    @Override
